...
from production.models import Product, ProductCategory
from site_module.models import SiteSetting, FooterLinkBox, Slider
from utils.convertor import group_list


class HomeView(TemplateView):
    template_name = 'home_models/indexpage.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        most_bhought_products = Product.objects.filter(detailorder__order__is_paid=True).annotate(
            order_count=Sum('detailorder__count')).order_by('order_count')[:12]
        context['most_bhought_products'] = group_list(most_bhought_products)
...
class AboutView(TemplateView):
    template_name = 'home_models/about_page.html'
