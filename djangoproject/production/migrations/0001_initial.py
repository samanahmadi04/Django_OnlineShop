# Generated by Django 4.1 on 2022-08-17 13:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(db_index=True, default='', verbose_name='توضیحات اصلی')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_tags', to='production.product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.ManyToManyField(related_name='product_categories', to='production.productcategory', verbose_name='دسته بندی ها'),
        ),
    ]
